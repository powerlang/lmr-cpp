...
/**
 * Flag bits in the object header. Tightly coupled with what the image
 * generator writes, so in the future, consider making the image generator
 * write this enum into a .h
 */
typedef enum
{
    IsBytes      = 0x01,
